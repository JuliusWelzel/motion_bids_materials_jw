...
## motionbids python package
This packges provides a lightweight conversion tool of motion data (e.g. IMU) to BIDS with [examples](https://juliuswelzel.github.io/motionbids/examples/). YOu can find the packages docs [here](https://juliuswelzel.github.io/motionbids/).

## Workshops and presentations 
Here are some talks or posters about MOTION-BIDS from the past :

- [CeTI](https://tu-dresden.de/tu-dresden/exzellenz/exzellenzcluster/ceti), TU Dresden, 2026 - [Materials](https://github.com/JuliusWelzel/BidsWS_TUDresden/tree/main) - [Slides](slides/2607_ceti_welzel_jeung.pdf)
- imove, Lübeck, 2025 - [Materials](https://github.com/JuliusWelzel/imove_bids_handson/tree/master) - [Slides](https://github.com/JuliusWelzel/imove_bids_handson/blob/master/bids_imove_welzel.pdf)
